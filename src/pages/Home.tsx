...
const Home = () => {
  return (
    <div className="min-h-screen bg-secondary py-12 pt-0 px-4 sm:px-6 lg:px-8 overflow-y-hidden">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
            <div className="p-6 flex-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                Having an emergency storage is crucial for ensuring that you
                have the necessary supplies during a crisis. This includes:
              </p>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
            <div className="p-6 flex-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                An emergency bagpack or "go bag" is a portable kit for 72-hour
                survival. Essential items include:
              </p>
              <ul className="mt-4 space-y-2 text-gray-600">
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 bg-primary rounded-full mr-2"></span>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
            <div className="p-6 flex-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                A financial safety net for unexpected expenses. Recommended
                savings:
              </p>
              <ul className="mt-4 space-y-2 text-gray-600">
                <li className="flex items-center">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-gray-600 mb-8">
            <div className="flex items-start">
              ...
              <p>
                Regularly check and update your emergency supplies to ensure
            ...
            <div className="flex items-start">
              ...
              <p>
                Share your emergency plans with family members and ensure
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-4">
              Not sure where to start? Begin with our basic guide!
            </p>
            <Link to="/plan">
